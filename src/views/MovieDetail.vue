      ...
      <div class="row">
        ...
        <div class="col-9 item-info">
          ...
          <ul id="toggle-tabs" class="d-flex justify-content-center mt-5">
            ...
            <li class="last d-flex justify-content-center align-items-center" @click="showTrailer">
              <span class="m-0">Trailer</span>
            </li>
          </ul>
          <transition name="fade">
            <div class="mt-5" v-if="show">
              <video width="640" height="380" controls autoplay muted
                     :src="Item.trailer" type="video/mp4">
              </video>
            </div>
          </transition>
...
#toggle-tabs > li:first-child {
  background: url(../../public/assets/logo/ribon_left_menu.gif) no-repeat scroll left 0 #e71a0f;
  padding-left: 19px;
}

#toggle-tabs > li.last {
  background: url(../../public/assets/logo/ribon_right.gif) no-repeat scroll right 0 #e71a0f;
  padding-right: 19px;
}
